...
It enables .NET developers to continue to use familiar coding patterns (insecure) like the following, but without the risk of introducing SQLi vulnerabilities into their applications:
````
