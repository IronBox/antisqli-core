...
In 2020, SQLi attacks continued to be the #1 web application attack and the vectors for this attack has also expanded, especially with higher cloud database platform adoption. In response, a new version of the original AntiSQLi library was written to improve usability, integration and protection coverage.
