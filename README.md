...
The **AntiSQLi library provides class extensions that automatically parameterizes and loads dynamic queries**. This means that developers can continue to use same single line pattern that they are used to, and the AntiSQLi library takes care of SQL query parameterization. Let's take a brief look at how this works:
